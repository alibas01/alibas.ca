      ...
      <div className="buttig-projects">
        <section className="project-links">
          ...
          <a
            target="_blank"
            rel="noopener noreferrer"
            href={"https://github.com/alibas01/tinyapp"}
          >
            <h4>* TinyApp</h4>
          </a>
          ...
          <a
            target="_blank"
            rel="noopener noreferrer"
            href={"https://github.com/alibas01/jungle"}
          >
            <h4>* Jungle</h4>
          </a>
          ...
          <a
            target="_blank"
            rel="noopener noreferrer"
            href={"https://github.com/alibas01/lotide2"}
          >
            <h4>* Lotide</h4>
          </a>
          <p>
            {" "}
            Stack: JS/ NPM library written for learning purposes for example
            Lodash functions{" "}
          </p>
          <a
            target="_blank"
        ...
        <div className="tesla">
          <img
            className="tesla-img"
            alt="tesla"
            src="https://raw.githubusercontent.com/alibas01/alibas.ca/master/public/images/tesla.jpg"
          />
        </div>
        <section className="project-links">
          <a
          ...
          <p>
            {" "}
            Stack: React, HTML, CSS, Bootstrap, Ruby, Postgres, Bcrypt, Puma,
            HTTParty
          </p>
          <a
            target="_blank"
            rel="noopener noreferrer"
            href={"https://github.com/alibas01/Aviation-Safety-Issues"}
          >
            <h4>* Aviation Safety Model</h4>
          </a>
          <p>
            {" "}
            NLP model on ASRS data set after going through data cleaning, data
            wrangling, exploratory data analysis, and some unique data
            visualization features. Stack: Python with Numpy, Pandas, Scipy,
            Seaborn, SKlearn
          </p>
          <a
            target="_blank"
            rel="noopener noreferrer"
            href={"https://github.com/alibas01/tweeter"}
          >
            <h4>* Tweeter</h4>
          </a>
          ...
          <a
            target="_blank"
            rel="noopener noreferrer"
            href={"https://github.com/alibas01/wiki-map-app"}
          >
            <h4>* Wiki-Map-App</h4>
          </a>
