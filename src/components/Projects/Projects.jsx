...
export default function Projects(props) {  
  return(
      ...
      <section className="project-links">
        <a target="_blank" rel="noopener noreferrer" href={'https://interview-scheduler-ali.netlify.app/'}>
          <h4>* Interview Scheduler</h4>
        </a>
            <p> Stack: React, Axios, Classnames, Normalize, Storybook, WS</p>
        <a target="_blank" rel="noopener noreferrer" href={'https://github.com/alibas01/tinyapp'}>
          <h4>* TinyApp</h4>
        </a>
            <p> Stack: NodeJS, Express | EJS, Bcrypt, cookie-sessions</p>
        <a target="_blank" rel="noopener noreferrer" href={'https://github.com/alibas01/jungle'}>
          <h4>* Jungle</h4>
        </a>
            <p> Stack: Ruby, Rails, Stripe, HTML, scss</p>
        <a target="_blank" rel="noopener noreferrer" href={'https://github.com/alibas01/lotide2'}>
          <h4>* Lotide</h4>
        </a>
            <p> Stack: JS/ NPM library written for learning purposes for example Lodash functions </p>
        <a target="_blank" rel="noopener noreferrer" href={'https://github.com/alibas01/Classifying-Nature-Pictures/blob/master/Capstone%20Project%202%20Final%20Report.pdf'}>
      ...
      <section className="project-links">
        <a target="_blank" rel="noopener noreferrer" href={'https://github.com/defsax/fly-fi'}>  
          <h4>* Fly-Fi</h4>
        </a>
          <p> Stack: React, HTML, CSS, Bootstrap, Ruby, Postgres, Bcrypt, Puma, HTTParty</p>
        <a target="_blank" rel="noopener noreferrer" href={'https://github.com/alibas01/Aviation-Safety-Issues'}>
        ...
        <a target="_blank" rel="noopener noreferrer" href={'https://github.com/alibas01/tweeter'}>
          <h4>* Tweeter</h4>
        </a>
          <p> Stack: JS Express, Node.js, HTML, CSS, jQuery, Ajax</p>
        <a target="_blank" rel="noopener noreferrer" href={'https://github.com/alibas01/wiki-map-app'}>
          <h4>* Wiki-Map-App</h4>
        </a>
